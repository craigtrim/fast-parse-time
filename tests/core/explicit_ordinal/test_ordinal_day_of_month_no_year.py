#!/usr/bin/env python
# -*- coding: UTF-8 -*-
"""Tests for 'NNth day of Month' (no year) pattern.

BEHAVIOR CHANGE (strict mode):
    Issue #63 changed this pattern to return empty {} (strict mode).
    Without a year, these are not parseable, actionable dates.
...
class TestOrdinalDayOfMonthNoYear:
    """'NNth day of Month' (no year) → {} (empty, strict mode per #63)."""
